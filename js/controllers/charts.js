...
function PieCtrl($scope) {
  $scope.labels = dashboard_pie_chart.labels;
  $scope.data = dashboard_pie_chart.data;
}

LineCtrl.$inject = ['$scope'];

function LineCtrl($scope) {
  $scope.labels = dashboard_line_chart.labels;
  $scope.series = dashboard_line_chart.series;
  $scope.data = dashboard_line_chart.data;
}
